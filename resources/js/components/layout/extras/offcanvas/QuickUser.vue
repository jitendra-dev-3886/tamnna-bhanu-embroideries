    ...
    <div class="topbar-item">
        ...
        >
            ...
            <span class="symbol symbol-35 symbol-light-success">
                <img alt="Pic" :src="picture" style="max-width: 30px" />
                <!--<span
                  v-if="true"
            ...
            >
                ...
                <div class="d-flex align-items-center mt-5">
                    <div class="d-flex flex-column">
                        ...
                        <div class="text-muted mt-1" v-if="roleName">
                            {{ roleName }}
                        </div>
...
class KTQuickUser extends mixins(CommonServices, Idle) {
    ...
    mounted() {
        ...
        this.username = UserModule.currentUserData.name;

        //  this.nameInitials = this.username.charAt(0);
        this.roleName = UserModule.currentUserData.role
            ? UserModule.currentUserData.role.name
            : "";
