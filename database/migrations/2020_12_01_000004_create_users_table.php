...
class CreateUsersTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('users', function (Blueprint $table) {
            ...
            $table->enum("user_status", ['0', '1'])->nullable()->comment("0 => 'Inactive', 1 => 'Active'");
            $table->string("password", 191)->nullable();
